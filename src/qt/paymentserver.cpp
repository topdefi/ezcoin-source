...
const QString BITCOIN_IPC_PREFIX("ezcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/ezcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ezcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ezcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click ezcoin: links
...
//
// OSX-specific way of handling ezcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in ezcoin: URIs
